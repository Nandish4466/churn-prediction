...
> ![Monthly Charges](https://github.com/Pradnya1208/Telecom-Customer-Churn-prediction/blob/main/output/carges%20distribution.PNG?raw=true) > ![Total Charges](https://github.com/Pradnya1208/Telecom-Customer-Churn-prediction/blob/main/output/total%20charges.PNG?raw=true) > ![Tenure](https://github.com/Pradnya1208/Telecom-Customer-Churn-prediction/blob/main/output/tenure%20and%20churn.PNG?raw=true)
...
4. **Open Jupyter Notebook**:
   ...
   - Navigate to the project directory:
     ```sh
     cd /c:/Users/nandu/Downloads/Telecom-Customer-Churn-prediction-main
     ```
...
5. **Run the notebook**:
   - Open the `Customer churn prediction.ipynb` file in Jupyter Notebook.
   - Execute each cell sequentially to run the code.

## Dataset

The dataset is located in the `data.csv` file in the project directory.

## Project Structure

- `Scripts/Customer churn prediction.ipynb`: Jupyter Notebook containing the code for the churn prediction.
...
5. **Open the project folder**:
   ...
   - Go to `File > Open Folder...` and select the `/c:/Users/nandu/Downloads/Telecom-Customer-Churn-prediction-main` folder.

6. **Run Jupyter Notebook in VS Code**:
   - Open the `Customer churn prediction.ipynb` file in VS Code.
   - You should see a prompt to install the Jupyter extension if it's not already installed. Follow the instructions to install it.
   - Once the Jupyter extension is installed, you can run the notebook cells by clicking on the "Run" button that appears above each cell.
